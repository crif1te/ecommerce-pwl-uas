                    ...
                    <?php $__currentLoopData = $dataType->readRows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="panel-body" style="padding-top:0;">
                            ...
                            <?php elseif($row->type == 'relationship'): ?>
                                <?php if($row->display_name == 'Order Products'): ?>
                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <th><img src="<?php echo e(productImage($product->image)); ?>" width="70" height="70"></th>
                                                    <th><?php echo e($product->price); ?></th>
                                                    <th><?php echo e($product->details); ?></th>
                            ...
                            <?php else: ?>
                                <?php echo $__env->make('voyager::multilingual.input-hidden-bread-read', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                <?php if($row->display_name == 'Total' || $row->display_name == 'Tax' || $row->display_name == 'Subtotal' || $row->display_name == 'Discount'): ?>
                                    <p>$<?php echo e(format($dataTypeContent->{$row->field})); ?></p>
                                <?php else: ?>
...
<?php echo $__env->make('voyager::master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Kuliah\Smt 4\PWL\Coding PWL\ecommerce-laravel-master-final\ecommerce-laravel-master\resources\views/vendor/voyager/orders/read.blade.php ENDPATH**/ ?>
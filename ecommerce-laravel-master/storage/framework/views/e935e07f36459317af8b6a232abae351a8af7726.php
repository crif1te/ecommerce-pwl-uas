                ...
                <tbody>
                    <?php $__currentLoopData = Cart::instance('default')->content(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td>$<?php echo e(format($item->subtotal)); ?></td>
                        </tr>
            ...
            <div class="summary">
                <div class="row">
                    ...
                    <div class="col-md-3 offset-md-1">
                        <p class="text-right light-text">Subtotal &nbsp; &nbsp;$<?php echo e(format(Cart::subtotal())); ?></p>
                        <p class="text-right light-text">Tax(21%) &nbsp; &nbsp; $<?php echo e(format(Cart::tax())); ?></p>
                        <p class="text-right">Total &nbsp; &nbsp; $<?php echo e(format(Cart::total())); ?></p>
                    </div>
                </div>
            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Kuliah\Smt 4\PWL\Coding PWL\ecommerce-laravel-master\ecommerce-laravel-master\resources\views/cart.blade.php ENDPATH**/ ?>